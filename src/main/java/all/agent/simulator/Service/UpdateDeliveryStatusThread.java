package all.agent.simulator.Service;


import all.agent.simulator.DbConfiguration;
import all.agent.simulator.Mapper.dn_data;
    ...
    public void unProcess() throws JsonProcessingException {
        ...
        if (isOn.equals("1"))
        {
            ...
            for (MessageData messageData : unprocess)
            {
                ...
                messageData.setDr_url(deliveryStatus);
